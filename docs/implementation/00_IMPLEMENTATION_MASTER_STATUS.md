...
| 2 App Shell | NOT_STARTED | pending | pending | pending | none | after Phase 1 |
| 3 Biblioteca | NOT_STARTED | pending | pending | pending | none | after Phase 2 |
| 4 AI Tools | NOT_STARTED | pending | pending | pending | none | after Phase 3 |
| 5 Aprendizaje | NOT_STARTED | pending | pending | pending | none | after Phase 4 |
