...
- `PRIVACY_POLICY_URL` must be public HTTPS. Android Play product IDs are public
...
| Production | Explicit non-local HTTPS API, public privacy URL, public Supabase config and Play product IDs | release AAB |
