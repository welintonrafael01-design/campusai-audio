# Google Play Store Listing Checklist - StudyBook AI
...
| Category | `HUMAN ACTION` | Education is the technical candidate; owner must select in Play Console. |
| 512x512 Play icon | `READY FOR EXPORT REVIEW` | 1024x1024 StudyBook source icon exists; verify Play crop/background. |
| Adaptive launcher icon | `READY` | Foreground/background resources exist. |
| Feature graphic | `MISSING` | Approved 1024x500 asset required; do not derive without brand approval. |
| Phone screenshots | `MISSING` | Capture final production-config build across Student, Teacher, Booky and AudioBook. No QA data. |
