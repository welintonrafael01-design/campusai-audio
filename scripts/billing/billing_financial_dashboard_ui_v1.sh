...
echo "===== BILLING FINANCIAL DASHBOARD UI V1 ====="

mkdir -p "$FLUTTER/lib/screens/admin"

cat > "$FLUTTER/lib/screens/admin/financial_dashboard_screen.dart" <<'DART'
import 'dart:convert';
...
echo ""
echo "===== ROUTE DIAGNOSTIC ====="
grep -R "plans_screen.dart\|GoRoute\|/plans\|settings" "$FLUTTER/lib" -n | head -80 || true
