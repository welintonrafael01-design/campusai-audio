...
echo "===== ADD EDUCATOR BACKEND ROUTES V1 ====="

cat > "$BACKEND/app/routes/educator.py" <<'PY'
...
import_line = "from app.routes.educator import router as educator_router\n"
...
include_line = "app.include_router(educator_router)\n"
...
echo ""
echo "===== ROUTE CHECK ====="
grep -R "educator_router\|prefix=\"/educator\"\|/snapshot\|/sync" app -n
